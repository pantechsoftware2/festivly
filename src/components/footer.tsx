      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-purple-200/70 hover:text-purple-200 text-sm transition-colors">
                  About Us
                </a>
              </li>
              <li>
        ...
        <div className="border-t border-purple-500/20 pt-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex gap-6">
              <a href="#" className="text-purple-200/70 hover:text-purple-200 transition-colors" title="Twitter">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2s9 5 20 5a9.5 9.5 0 00-9-5.5c4.75 2.25 9-7.5 9-7.5z" />
                </svg>
              </a>
              <a href="#" className="text-purple-200/70 hover:text-purple-200 transition-colors" title="LinkedIn">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-2-2 2 2 0 00-2 2v7h-4v-7a6 6 0 016-6zM2 9h4v12H2z" />
                  <circle cx="4" cy="4" r="2" />
                </svg>
              </a>
              <a href="#" className="text-purple-200/70 hover:text-purple-200 transition-colors" title="GitHub">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
